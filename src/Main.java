...
public class Main {
       public static void main(String[]args) {
           ...
           bootcamp.setDescricao("Desçriçao Bootcamp Java Developer");
           ...
           System.out.println("Conteudos incritos Leonardo \n" + devLeonardo.getConteudosInscritos() );
           devLeonardo.progredir();
           System.out.println("-");
           System.out.println("Conteudos incritos Leonardo \n" + devLeonardo.getConteudosInscritos() );
           System.out.println("Conteudos concluidos Leonardo \n" + devLeonardo.getConteudosConcluidos());
           System.out.println("XP: \n" + devLeonardo.calcularTotalXp());
           ...
           System.out.println("Conteudos incritos Camila \n" + devCamila.getConteudosInscritos() );
           devCamila.progredir();
           System.out.println("-");
           System.out.println("Conteudos incritos Camila \n" + devCamila.getConteudosInscritos() );
